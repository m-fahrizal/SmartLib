...
public class JournalDetail4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seeMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent openAbstract1 = new Intent(getApplicationContext(), JournalAbstract4.class);
        ...
        btnBorrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bookdata.put("namaBuku", "Automatic extraction of product line architecture and feature models from\n" +
                        "UML class diagram variants");
                bookdata.put("penulis", "Wesley K.G. Assunção, Silvia R. Vergilio, dkk");
                bookdata.put("tahun", "2019");
                bookdata.put("idBuku", 10);
