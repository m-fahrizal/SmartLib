...
public class BookDetail3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bookdata.put("namaBuku", "PostgreSQL 14 Administration Cookbook");
                bookdata.put("penulis", "Simon Riggs and Gianni Ciolli");
                bookdata.put("tahun", "2010");
                bookdata.put("idBuku", 3);
